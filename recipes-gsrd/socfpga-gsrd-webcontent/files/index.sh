...
echo -e "<ul>"
	echo -e "<li><a href=\"https://docs.altera.com/p/design-resources/example-design-hub/\" target=\"_blank\">Example Design Hub</a></li> "
	echo -e "<li><a href=\"https://community.altera.com/category/forums/\" target=\"_blank\">Community Forums</a></li> "
	echo -e "<li><a href=\"https://community.altera.com/category/top/kb/knowledge-base/\" target=\"_blank\">Knowledge Database</a></li> "
	echo -e "<li><a href=\"https://github.com/altera-fpga/gsrd-socfpga/releases/\" target=\"_blank\">eSW Release Notes</a></li> "
echo -e "</ul>"
echo -e "</div>"
