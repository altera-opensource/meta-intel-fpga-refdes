...
SRC_URI:agilex ?= "${GHRD_REPO}/${IMAGE_TYPE}/agilex_${IMAGE_TYPE}/${ARM64_GHRD_CORE_RBF};name=agilex_${IMAGE_TYPE}_core"
...
SRC_URI:cyclone5 ?= "${GHRD_REPO}/${IMAGE_TYPE}/c5_${IMAGE_TYPE}/${C5_GHRD_CORE_RBF};name=c5_${IMAGE_TYPE}_core"
