...
echo -e "<img src=\"../altera-logo.jpg\" alt=\"Altera Logo\" style=\"float:left; padding:15px 0px 15px 10px;\"/>"
...
echo -e "<ul>"	
	...
	echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<ul>"
    ...
    echo -e "<li><a href=\"https://docs.altera.com/v/u/docs/654388/arria-v-soc-fpga-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
	echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<ul>"
    ...
    echo -e "<li><a href=\"https://docs.altera.com/r/docs/683227/current/arria-10-sx-soc-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
	echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<ul>"
        ...
        echo -e "<li><a href=\"https://docs.altera.com/r/docs/683303/current/stratix-10-sx-soc-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
        echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<h4>Developer Resources</h4>"
echo -e "<ul>"
        echo -e "<li><a href=\"https://www.intel.com/content/www/us/en/products/details/fpga/development-kits/agilex/f-series-transceiver/si-agf014.html\" target=\"_blank\">Agilex7 DK-SI-AGF014EB SoC Quick Start Guide</a></li> "
        echo -e "<li><a href=\"https://docs.altera.com/r/docs/683752/current/agilextm-7-fpga-f-series-transceiver-soc-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
        echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<ul>"
        ...
        echo -e "<li><a href=\"https://docs.altera.com/r/docs/739942/current/agilextm-7-fpga-f-series-2-f-tiles-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
        echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<h4>Developer Resources</h4>"
echo -e "<ul>"
        echo -e "<li><a href=\"https://www.intel.com/content/www/us/en/products/details/fpga/development-kits/agilex/i-series-transceiver/si-agi027.html\" target=\"_blank\">Agilex7 DK-SI-AGI027FC SoC Quick Start Guide</a></li> "
        echo -e "<li><a href=\"https://docs.altera.com/r/docs/721605/current/agilextm-7-fpga-i-series-transceiver-soc-development-kit-user-guide\" target=\"_blank\">User Guide</a></li> "
        echo -e "<li><a href=\"https://altera-fpga.github.io/\" target=\"_blank\">Altera FPGA</a></li> "
echo -e "</ul>"
echo -e "</div>"
...
echo -e "<div class=\"bup-form\">"
echo "<hr style=\"border: 1px solid; color:#001e50\"><br>"
...
if [ "$MACHINE" == "cyclone5" ]; then
	...
	echo -e "<span><strong><h1>$DEVKIT_NAME Features</h1></strong><br/></span>"
        echo -e "<div><img src=\"../agilex7_dk_si_agf014eb-board-image.jpg\" style=\"width:640px;height:478px;\"></div>"
elif [[ "$MACHINE" == "agilex7_dk_dev_agf023fa" ]]; then
	echo -e "<span><strong><h1>$DEVKIT_NAME Features</h1></strong><br/></span>"
        echo -e "<div><img src=\"../agilex7_dk_dev_agf023fa-board-image.jpg\" style=\"width:640px;height:478px;\"></div>"
elif [[ "$MACHINE" == "agilex7_dk_si_agi027f"* ]]; then
	echo -e "<span><strong><h1>$DEVKIT_NAME Features</h1></strong><br/></span>"
        echo -e "<div><img src=\"../agilex7_dk_si_agi027fc-board-image.jpg\" style=\"width:640px;height:478px;\"></div>"
fi
...
if [ "$MACHINE" != "agilex5" ]; then
 ...
 echo -e "<br> <hr style=\"border: 1px solid; color:#001e50\"> <br>"
...
echo -e "<div id=\"footer\" class=\"footer-container\">"
	...
	echo -e "<p align=\"center\" style=\"width:900px; font-size:9px;\">Copyright &copy; 2025 Altera Corporation. All Rights Reserved.<br/>"
